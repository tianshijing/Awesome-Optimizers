...
I present a meticulously curated roadmap of optimizers, as depicted in the ![Optimizer's Roadmap](Fig/Awesome_optimizers.jpg), which is an excellent chronological compilation of optimization techniques. This roadmap is continuously updated to reflect the latest advancements. Should you identify any typographical errors or omissions in the referenced papers, please do not hesitate to open an issue or submit a pull request. Our ongoing survey is in the process of being updated, and this represents the most current iteration.
